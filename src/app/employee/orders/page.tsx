...
import { Eye, CheckCircle, Truck, Search, Filter, Printer } from "lucide-react";
...
// Minimalistic ShoppingBag icon if not available in lucide-react directly or for specific use
