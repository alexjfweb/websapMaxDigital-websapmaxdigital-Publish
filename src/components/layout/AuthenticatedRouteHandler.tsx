...
// Este componente ahora contiene la lógica Y la estructura del panel de administración
export default function AuthenticatedRouteHandler({ children }: { children: React.ReactNode }) {
  ...
  if (!currentUser) {
    // Aunque el SessionProvider redirige, esta es una capa de seguridad adicional.
    return <SimpleLoader message="Acceso no autorizado. Redirigiendo..." />;
  }
  ...
  // Si el usuario está autenticado, renderizamos el layout completo del panel
  return (
    <>
