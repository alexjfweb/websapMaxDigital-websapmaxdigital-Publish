  ...
  sections: [
    {
      ...
      subsections: [
        ...
        { id: 'sub-1-3', title: 'Sistema de menú digital con pago desde el móvil', content: '<img src="https://images.pexels.com/photos/580612/pexels-photo-580612.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Pago digital desde el móvil" style="width:100%; border-radius:12px; margin-bottom:10px;">Olvídate de los menús físicos y ofrece a tus clientes un menú moderno y seguro. Elige entre diseños elegantes, añade fotos y vídeos, y actualízalo en tiempo real. Reduce costos de impresión, mejora la experiencia del cliente y agiliza el servicio.', imageUrl: 'https://images.pexels.com/photos/580612/pexels-photo-580612.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', authorRole: '', imageRadius: 0 },
      ],
    },
    {
