...
const serializePlan = (id: string, data: any): LandingPlan => ({
  ...
  maxOrders: data.maxOrders ?? -1, // Serializar nuevo campo
      ...
      const defaultPlans: CreatePlanRequest[] = [
        {
            ...
            currency: 'USD',
            period: 'lifetime',
            features: ['5 Mesas', '5 Empleados', '10 Reservas/mes', 'Menú Digital Básico', '100 Pedidos/mes'],
            isActive: true,
            isPublic: false,
            order: 99,
            icon: 'zap',
        ...
        },
        {
            name: 'Plan Uno',
            slug: 'plan-uno',
            description: 'Perfecto para comenzar a digitalizar tu negocio.',
            price: 5,
            currency: 'USD',
            period: 'monthly',
        ...
        },
        {
            name: 'Plan Básico',
            slug: 'plan-basico',
            description: 'Ideal para pequeños restaurantes y food trucks que empiezan a digitalizarse.',
            price: 10,
            currency: 'USD',
            period: 'monthly',
            features: ['20 Mesas', '10 Empleados', '50 Reservas/mes', '100 Pedidos/mes', 'Menú Digital con QR'],
            isActive: true,
            isPublic: true,
            isPopular: false,
            order: 1,
        ...
        },
        {
            name: 'Plan Estándar',
            slug: 'plan-estandar',
            description: 'Para restaurantes que buscan crecer y optimizar su operación diaria.',
            price: 25,
            currency: 'USD',
            period: 'monthly',
            features: ['Mesas Ilimitadas', '25 Empleados', 'Reservas Ilimitadas', '2000 Pedidos/mes', 'Personalización de Menú'],
            isActive: true,
            isPublic: true,
            isPopular: true,
            order: 2,
        ...
        },
        {
            name: 'Plan Premium',
            slug: 'plan-premium',
            description: 'Funcionalidades avanzadas y soporte prioritario para grandes operaciones.',
            price: 50,
            currency: 'USD',
            period: 'monthly',
            features: ['Todo en Estándar', 'Pedidos Ilimitados', 'Analítica Avanzada', 'Soporte Prioritario 24/7', 'Integraciones personalizadas'],
            isActive: true,
            isPublic: true,
            isPopular: false,
            order: 3,
        ...
        },
        {
          ...
          currency: 'USD',
          period: 'monthly',
          features: ['Mesas Ilimitadas', 'Empleados Ilimitados', 'Reservas Ilimitadas', 'Pedidos Ilimitados', 'Soporte Prioritario'],
          isActive: true,
          isPublic: true,
          isPopular: false,
          order: 4,
