    ...
    if (plansSnapshot.empty) {
      ...
      const defaultPlans: CreatePlanRequest[] = [
        ...
        },
        {
            ...
            currency: 'USD',
            period: 'monthly',
            features: ['10 Mesas', '5 Empleados', '20 Reservas/mes'],
            isActive: true,
            isPublic: true,
            isPopular: false,
            order: 0,
        ...
        },
        {
            ...
            currency: 'USD',
            period: 'monthly',
            features: ['20 Mesas', '10 Empleados', '50 Reservas/mes', 'Menú Digital con QR'],
            isActive: true,
            isPublic: true,
            isPopular: false,
            order: 1,
        ...
        },
        {
            ...
            currency: 'USD',
            period: 'monthly',
            features: ['Mesas Ilimitadas', '25 Empleados', 'Reservas Ilimitadas', 'Personalización de Menú'],
            isActive: true,
            isPublic: true,
            isPopular: true,
            order: 2,
        ...
        },
        {
            ...
            currency: 'USD',
            period: 'monthly',
            features: ['Todo en Estándar', 'Analítica Avanzada', 'Soporte Prioritario 24/7', 'Integraciones personalizadas'],
            isActive: true,
            isPublic: true,
            isPopular: false,
            order: 3,
