    ...
    if (plansSnapshot.empty) {
      ...
      const defaultPlans: CreatePlanRequest[] = [
        ...
        },
        {
            ...
            currency: 'USD',
            period: 'monthly',
            features: ['20 Mesas', '10 Empleados', '50 Reservas/mes', '1200 Pedidos/mes', 'Menú Digital con QR', 'Hasta 40 platos', '250 Sugerencias IA/mes'],
            isActive: true,
            isPublic: true,
            isPopular: false,
            order: 1,
        ...
        },
        {
          ...
          currency: 'USD',
          period: 'monthly',
          features: ['Mesas Ilimitadas', 'Empleados Ilimitados', '20 Reservas mensuales', 'Pedidos Ilimitados', 'Soporte Prioritario'],
          isActive: true,
          isPublic: true,
          isPopular: false,
          order: 4,
